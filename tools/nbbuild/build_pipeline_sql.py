...
Без этого любая цифра ниже повисает в воздухе.
"""),
...
А минимальная длительность этапа в сырых данных отрицательная, то есть цифра
не просто смещена, она невозможна.
